  ...
  return (
    ...
    <section className="homescreen m-0 flex flex-col w-screen justify-center bg-gray-800 h-screen text-gray-100 ">
        ...
        <div className="flex justify-end mr-4 mb-4">     
            <button className="rounded px-3 py-2 m-1  shadow-lg bg-orange-400 " href="" onClick={()=> window.open("https://github.com/MartinRot/Pokedex", "_blank")}>
                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-gray-800 fill-current text-center">
            ...
            <button className="rounded px-3 py-2 m-1  shadow-lg bg-orange-400 " href="">
                <svg className="w-5 h-5 fill-current text-gray-800" role="img" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" onClick={()=> window.open("https://www.linkedin.com/in/martin-rotelli/", "_blank")}>
